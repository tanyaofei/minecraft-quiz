...
public class QuestionQueueCommand extends ExecutableCommand {

    public final static QuestionQueueCommand instance = new QuestionQueueCommand(
            "查看出题顺序表",
            "/quizadmin question queue [页码] [数量]",
            "quizadmin.*"
    );
    ...
    private final static int DEFAULT_PAGE_SIZE = 10;
        ...
        public static Component help = Helps.help(
                ...
                new Helps.Content("例子", List.of(
                        "/quizadmin question queue      - 查看第 1 页",
                        "/quizadmin question queue 2    - 查看第 2 页",
                        "/quizadmin question queue 2 5  - 查看第 2 页, 每页 5 条"
                ))
        );

    public QuestionQueueCommand(@NotNull String description, @NotNull String usage, @Nullable String permission) {
    ...
    protected boolean execute(
        ...
        var page = repository.selectQueuePage(current, size);
